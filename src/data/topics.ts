...
export const topicHubs: TopicHub[] = [
  ...
  },
  {
    ...
    quickAnswer: {
      ...
      answer:
        "Adults 18+ can buy disposable vapes online from authorised Australian retailers with clear shipping and authenticity policies. Alibarbar Australia stocks the Ingot 9000 range with guides, comparisons and A$15 shipping for 1–9 devices (A$10 for 10–19, free for 20+).",
    },
    keyTakeaways: [
      "18+ only",
