...
export const blogPosts: BlogPost[] = [
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "At Alibarbar Australia, standard shipping is A$15 for orders of 1–9 devices, A$10 for 10–19 devices, and free for 20 or more, with 3–7 business day delivery Australia-wide.",
      },
    ],
    sections: [
      {
