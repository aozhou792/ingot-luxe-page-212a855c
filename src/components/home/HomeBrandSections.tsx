...
const whyReasons = [
  ...
  },
  {
    ...
    desc: "A$15 for 1–9, A$10 for 10–19, free for 20+ devices. Dispatched after payment confirmation, typically 3–7 business days.",
  },
  {
    icon: Check,
  ...
  <section id="why-choose" className={sectionPad}>
    <div className="container">
      ...
      <p className="text-center mt-8 text-sm text-muted-foreground reveal max-w-2xl mx-auto leading-relaxed">
        ...
        <Link to="/best-alibarbar-australia" className="text-primary font-semibold hover:text-gold">Best Alibarbar Australia</Link>,{" "}
        <Link to="/about-alibarbar-australia" className="text-primary font-semibold hover:text-gold">About Alibarbar Australia</Link>,{" "}
    ...
    <div className="container max-w-3xl">
      <div className="reveal rounded-2xl border border-gold/25 bg-card/50 p-6 sm:p-8 space-y-4">
        ...
        <p className="text-muted-foreground text-sm sm:text-base leading-[1.8]">
          We dispatch Australia-wide via Regular Post after your bank transfer is verified. Shipping is A$15 for
          1–9 devices and A$10 for 10–19 devices (free for 20+). Most metro deliveries arrive within 3–7 business days. Payment is
