...
const reasons = [
  ...
  { icon: ShieldCheck, title: "Strictly 18+", desc: "Entry age gate plus mandatory 18+ confirmation at checkout." },
  { icon: PackageCheck, title: "Tiered shipping", desc: "A$15 for 1–9, A$10 for 10–19, free for 20+ devices." },
