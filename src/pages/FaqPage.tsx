            ...
            <div className="mt-6">
              <QuickAnswer
                data={{
                  ...
                  answer:
                    "This FAQ answers the most common questions about Alibarbar Ingot 9000 disposable vapes in Australia — including shipping (A$20 under 5, A$10 for 5–19, free for 20+), bank transfer payment, puff counts (up to 9000), 10+ flavours, authenticity, age requirements (18+) and safe storage.",
                }}
              />
            </div>
          </header>
